...
try:
    ...
    # 2. Create boxplots comparing toxicity metrics
    ...
    # Create dataframes
    hindi_boxplot_df = pd.DataFrame(hindi_boxplot_data)
    english_boxplot_df = pd.DataFrame(english_boxplot_data)
    
    # Hindi boxplots
    if not hindi_boxplot_df.empty:
        plt.figure(figsize=(15, 10))
        sns.boxplot(x='Metric', y='Value', hue='Category', data=hindi_boxplot_df, palette='Set2')
    ...
    # English boxplots
    if not english_boxplot_df.empty:
        plt.figure(figsize=(15, 10))
        sns.boxplot(x='Metric', y='Value', hue='Category', data=english_boxplot_df, palette='Set2')
