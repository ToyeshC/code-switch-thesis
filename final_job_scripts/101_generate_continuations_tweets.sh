...
#SBATCH --job-name=101_generate_continuations_tweets
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH --mem=64G
#SBATCH --time=02:00:00
#SBATCH --output=final_job_outputs/101_generate_continuations_tweets_%A.out
...
# --- Configuration ---
INPUT_FILE="final_outputs/filtered_negative_tweets.csv"
OUTPUT_FILE="final_outputs/continuations_tweets.csv"
BATCH_SIZE=16
